...
#include "user_wifi.h"       // Header for Wi-Fi initialization and scanning functions

#define USER_SSID "ESP32-S3-Touch-LCD-7B"  // Wi-Fi SSID (network name)
...
void setup() {
    ...
    Paint_DrawString_EN(30, 200, "WiFi AP Test", &Font24, RED, WHITE);       // Display Wi-Fi scan test message
    Paint_DrawString_EN(30, 240, "1024x600", &Font24, RED, WHITE);              // Display resolution
